...
public class Day10 {
    ...
    public int part1(File file) throws FileNotFoundException {
        ...
        for (Position position : positions) {
            ...
            List<Position> trailheads = search(positions, position);
    ...
    public List<Position> search(List<Position> positions, Position currentPosition) {
        ...
        for (Direction direction : Direction.values()) {
            ...
            if (currentPosition.height + 1 == nextPosition.height) {
                if (nextPosition.height == 9) {
                    ...
                    for (Position position : search(positions, nextPosition)) {
